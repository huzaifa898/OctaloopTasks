...
const PixacioSection = () => {
  return (
    <div className="min-h-screen px-4 py-8 md:p-8 mt-28">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 ">
        {/* Left Side */}
        <div className="flex flex-col items-center lg:items-start">
          {/* Image */}
          <div className="relative bg-white rounded-xl shadow-lg overflow-hidden w-full lg:w-[514px] h-[300px] lg:h-[572px]">
            <img
              src={pxico}
              alt="Pixacio Item"
          ...
          {/* Description */}
          <div className="bg-white p-4 lg:p-6 rounded-xl shadow-lg mt-4 w-full lg:w-[546px]">
          ...
          <div className="bg-white p-4 lg:p-6 rounded-xl shadow-lg mt-4 w-full lg:w-[546px]">
            ...
            <div className="grid grid-cols-2 gap-2 md:gap-4">
              {[...Array(6)].map((_, index) => (
                <div
                  key={index}
                  className="bg-gray-100 p-2 md:p-4 rounded-lg text-center"
                >
