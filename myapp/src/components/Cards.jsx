...
function PromptExamples() {
  return (
    <div className="py-16 px-4 md:px-6">
      <h2 className="text-3xl font-apex text-start ml-4 mb-12 md:ml-20 lg:ml-80">PROMPT EXAMPLES</h2>
      <div className="grid grid-cols-1 gap-6 max-w-full mx-auto md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
