...
function PromptExamples() {
  ...
  <div className="grid grid-cols-1 gap-6 max-w-[1200px] mx-auto md:grid-cols-2">
    {cardsData.map((card, index) => (
      <div
        key={index}
        className="relative flex bg-white shadow-md rounded-lg overflow-hidden border hover:shadow-lg transition-shadow mx-auto"
        style={{ width: "577px", height: "262px" }}
      >
        {/* Image Section */}
