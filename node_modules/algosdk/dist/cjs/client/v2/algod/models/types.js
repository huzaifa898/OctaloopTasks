...
class BlockHeaderResponse {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'blockHeader',
                valueSchema: block_js_1.Block.encodingSchema,
                omitEmpty: true,
            });
        }
        return this.encodingSchemaValue;
    ...
    static fromEncodingData(data) {
        ...
        return new BlockHeaderResponse({
            blockheader: block_js_1.Block.fromEncodingData(data.get('blockHeader') ?? new Map()),
        });
    }
}
exports.BlockHeaderResponse = BlockHeaderResponse;
/**
